...
$(document).ready(function () {
  ...
  $("#contact-submit").on("click", function (e) {
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://interactivedev-8bc3.restdb.io/rest/contact",
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://interactivedev-8bc3.restdb.io/rest/contact/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
      ...
      "data": JSON.stringify(jsondata),
      "beforeSend": function(){
        $("#update-contact-submit").prop( "disabled", true);
      }
    }
    ...
    $.ajax(settings).done(function (response) {
      console.log(response);
      $("#update-contact-container").fadeOut(1000);
  ...
  function deleteForm(id) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://interactivedev-8bc3.restdb.io/rest/contact/${id}`,
      "method": "DELETE",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
